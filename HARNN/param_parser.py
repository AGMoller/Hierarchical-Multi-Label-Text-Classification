...
def parameter_parser():
    ...
    parser.add_argument("--word2vec-file", nargs="?", default="data/word2vec_dsl_sentences_reddit_sentences_300_cbow_negative/word2vec_dsl_sentences_reddit_sentences_300_cbow_negative.kv",
    ...
    parser.add_argument("--total-classes", type=int, default=220, help="Total number of labels. (depends on the task)")
